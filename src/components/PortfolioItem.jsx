  ...
  return (
    <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
        ...
        <div className='w-full p-4 i justify-center flex flex-col items-center'>
            ...
            <a href={link}>
                <button className='text-center px-5 py-2 w-max tezt-base font-medium rounded-md text-white bg-gradient-to-r from-blue-600 to-pink-600 drop-shadow-md mt-4'>Demo</button>
            </a>
        </div>
    </div>
  )
