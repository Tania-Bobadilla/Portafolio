    ...
    <div className='flex flex-col mb-10 mx-auto'>
      ...
      <div className='flex justify-center items-center'>
        <form action="https://getform.io/slug" method='POST' className='flex flex-col w-full md:w-7/12' >
            ...
            <button type='button' className='text-center inline-block px-8 py-3 w-max tezt-base font-medium rounded-md text-white bg-gradient-to-r from-yellow-300 to-pink-500 drop-shadow-md items-center'>Contáctame</button>
        </form>
      </div>
    </div>
  )
